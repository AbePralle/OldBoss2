...
class BossStringBuilder implements CharSequence, Comparable<String>
{
  ...
  public BossStringBuilder()
  {
    this( 128 );
  }

  public BossStringBuilder( int minimumCapacity )
  {
    characters = new char[ minimumCapacity ];
  }

  public BossStringBuilder clear()
  {
    count = 0;
    hash = 0;
    isValid = true;
  ...
  public BossStringBuilder print( String value )
  {
  ...
  public BossStringBuilder print( char value )
  {
    reserve( 1 );
  ...
  public BossStringBuilder print( int value )
  {
    return print( ""+value );
  }

  public BossStringBuilder reserve( int additional )
  {
  ...
  public BossStringBuilder subSequence( int i1, int limit )
  {
    BossStringBuilder result = new BossStringBuilder( limit - i1 );
    int code = 0;
